...
const contactItems = [
    {
        ...
        title: "Email",
        value: "hammadraza2559@gmail.",
        link: "hammadraza2559@gmail.com",
    },
    {
        icon: <Linkedin className="size-7 text-muted-foreground" />,
        title: "LinkedIn",
        value: "@hammadraza2559",
        link: "https://www.linkedin.com/in/hammad-raza-869a6631a/",
    },
    {
        icon: <Github className="size-7 text-muted-foreground" />,
        title: "GitHub",
        value: "@hammadraza2559-a11y",
        link: "https://github.com/hammadraza2559-a11y",
    },
];
